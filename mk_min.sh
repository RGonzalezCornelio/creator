...
cat js/creator_bigint.js \
    ...
    components/architecture/cache_definition/creator_uielto_cache_definition_one_level.js \
    components/architecture/cache_definition/creator_uielto_cache_definition_two_level.js \
    components/architecture/cache_definition/creator_uielto_cache_definition_three_level.js \
