 ...
 */
  ...
  var uielto_register_file_new = {
    ...
    methods:    {
                  ...
                  //Configuration of the level one cache
                  cache_level_one_configuration()
                  {
    ...
    template:   '<b-modal  :id ="id" ' +
                '          title = "Cache Level 1 Configuration"' +
                '          ok-title="Save" ' +
                '          @ok="verify_new_register_file" ' +
                '          v-model="show_modal" ' +
                '          @hidden="clean_form">' +
                '  <b-form>' +
                '    <b-form-group label="Tipo de Cache:">' +
                '      <b-form-input type="radio" value="Unificada" ' +
